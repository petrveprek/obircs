...
void doBaz()
{
    ...
    SCRIBO(LOG, "Regular with parameter:");                                              // Category BAZ, verbosity LOG.
    ...
    SCRIBO(LOG, "Regular without parameter:");                                           // Category BAZ, verbosity LOG.
    ...
    SCRIBO(LOG, "Shorthand with parameter:");                                            // Category BAZ, verbosity LOG.
    ...
    SCRIBO(LOG, "Shorthand without parameter:");                                         // Category BAZ, verbosity LOG.
