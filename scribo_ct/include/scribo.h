...
#       ifdef     SCRIBO_SUPPRESS_TIMESTAMP
#           undef SCRIBO_SUPPRESS_TIMESTAMP
#       endif
#       define    SCRIBO_SUPPRESS_TIMESTAMP 1
#       ifdef     SCRIBO_SUPPRESS_COUNTER
#           undef SCRIBO_SUPPRESS_COUNTER
#       endif
...
#   define IF_SCRIBO(...) SCRIBO_EXPAND_1(IF_SCRIBO_WITH_CONDITION( \
        SCRIBO_INVOKE_2(SCRIBO_PASTE_2, SCRIBO_DEFAULT_CONDITION_, SCRIBO_GET_IS_EMPTY(__VA_ARGS__))__VA_ARGS__))
